...
как всё запускает по отдельности

* установка зависимостей
* сборка пакета
* запуск и конфигурирование rviz 
* запуск всех компонентов: robot_state_publisher, joint_state_publisher, joint_state_publisher_gui
...
1. [Getting Ready for ROS Part 7: Describing a robot with URDF]
